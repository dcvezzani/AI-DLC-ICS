...
Use these when creating parent Features and child work items for AIDLC. **Product Spec links must be `blob/<branch>/…` URLs** — see [GITHUB-ISSUE-SPEC-LINKS.md](https://github.com/dcvezzani/AI-DLC/blob/main/docs/GITHUB-ISSUE-SPEC-LINKS.md).
