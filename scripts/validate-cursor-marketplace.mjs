#!/usr/bin/env node
/**
 * Validates `.cursor-plugin/marketplace.json` and plugin layouts using the same
 * rules as Cursor's official plugin template (team marketplace / indexer).
 *
 * Upstream: https://github.com/cursor/plugin-template/blob/main/scripts/validate-template.mjs
 * Run from repo root: `node scripts/validate-cursor-marketplace.mjs`
 */
